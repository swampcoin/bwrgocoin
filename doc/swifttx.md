...
* WebSocket: [https://github.com/UCC-Core/insight-api-ucc#web-socket-api](https://github.com/UCC-Core/insight-api-ucc#web-socket-api)
* API: [https://github.com/UCC-Core/insight-api-ucc#swifttx-transactions](https://github.com/UCC-Core/insight-api-ucc#swifttx-transactions)
...
By default, the UCC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the UCC Core daemon:

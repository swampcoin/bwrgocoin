...
*Setup instructions for a gitian build of NWO using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the NWO
...
- [Building NWO](#building-bwrgocoin)
...
To build NWO (for Linux, OSX and Windows) just follow the steps under 'perform

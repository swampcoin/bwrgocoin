...
In order to support loading of multiple wallets in nwo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nwo.cpp.
...
Changes to nwo.cpp
----------------------
nwo.cpp is the entry point into nwo-qt, and as such, will require some minor modifications to provide hooks for

...
In order to support loading of multiple wallets in ucc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ucc.cpp.
...
Changes to ucc.cpp
----------------------
ucc.cpp is the entry point into ucc-qt, and as such, will require some minor modifications to provide hooks for

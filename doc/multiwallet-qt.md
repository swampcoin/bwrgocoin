...
In order to support loading of multiple wallets in bwrgocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bwrgocoin.cpp.
...
Changes to bwrgocoin.cpp
----------------------
bwrgocoin.cpp is the entry point into bwrgocoin-qt, and as such, will require some minor modifications to provide hooks for

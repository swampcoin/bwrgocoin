TOR SUPPORT IN BWRGO
=======================

It is possible to run BWRGO as a Tor hidden service, and connect to such services.
...
Run BWRGO behind a Tor proxy
----------------------------------

The first step is running BWRGO behind a Tor proxy. This will already make all
...
HiddenServicePort 989 127.0.0.1:4444
...
your bwrgocoind's P2P listen port (4444 by default).
```
...
and open port 4444 on your firewall (or use -upnp).
...
List of known BWRGO Tor relays       **TO-DO**
------------------------------------
```

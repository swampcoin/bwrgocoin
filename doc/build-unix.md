...
Note
---------------------
Always use absolute paths to configure and compile bwrgocoin and the dependencies,
...
This will build bwrgocoin-qt as well if the dependencies are met.
...
Once these are installed, they will be found by configure and a bwrgocoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip bwrgocoind" to strip the debug
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, bwrgocoin should be built with a non-executable stack

Contributing to NWO Core
============================

The NWO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NWO Core project, and is not to be
confused with overall NWO Network Protocol consensus changes.

Whether a pull request is merged into NWO Core rests with the project merge
...
Patches that change NWO consensus rules are considerably more involved than
...
Where a patch set proposes to change the NWO consensus, it must have been
...
The project leader is the release manager for each NWO Core release.

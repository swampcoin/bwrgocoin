Contributing to BWRGO Core
============================

The BWRGO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BWRGO Core project, and is not to be
confused with overall BWRGO Network Protocol consensus changes.

Whether a pull request is merged into BWRGO Core rests with the project merge
...
Patches that change BWRGO consensus rules are considerably more involved than
...
Where a patch set proposes to change the BWRGO consensus, it must have been
...
The project leader is the release manager for each BWRGO Core release.

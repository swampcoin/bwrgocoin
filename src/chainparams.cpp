...
public:
    CMainParams()
    {
        ...
        vBWRGODevKey = ParseHex("0329b41789e8fd75dc7168d05dec322c25df364f6b010fb59c96b4637e5f4487cb"); // TEAMPubKey for fees
        vBWRGOFundKey = ParseHex("031f3b25791150d4243608c51f39c13a5b340cb73e4bf44c4d0258ad65506cd6c2"); // SWAPPubKey for fees
        nDevFee = 0; // TEAMFee %
        nFundFee = 0; // SWAPFee %
        nDefaultPort = 4444;
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // BWRGO: 1 minute
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 10;  // BWRGO: 10 seconds
        nLastPOWBlock = 1000;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 128); // Testnet BWRGO addresses start with 't'

...
/** Class encapsulating UCC Core startup and shutdown.
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. UCC can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}

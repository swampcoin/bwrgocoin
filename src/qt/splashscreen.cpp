...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBWRGO = QChar(0xA9) + QString(" 2018-2019 ").arg(COPYRIGHT_YEAR) + QString(tr("The BWRGO developers"));
    ...
    pixPaint.drawText(paddingLeft + 120, paddingTop, titleText);

    pixPaint.setFont(QFont(font, 8 * fontFactor));
    pixPaint.drawText(paddingLeft + 190, paddingTop, versionText);
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 40, copyrightTextBWRGO);

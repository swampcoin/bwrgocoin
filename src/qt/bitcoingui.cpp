...
QFontDatabase::addApplicationFont(":/fonts/bwrgocoin_font");

QString windowTitle = tr("BWRGO Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BWRGO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BWRGO: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BWRGO Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about BWRGO Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BWRGO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BWRGO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BWRGO addresses"));
    ...
    openAction->setStatusTip(tr("Open a BWRGO: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BWRGO Wallet help message to get a list with possible BWRGO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BWRGO client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BWRGO network", "", count));
}
...
{
    QString strTitle = tr("BWRGO Wallet"); // default title

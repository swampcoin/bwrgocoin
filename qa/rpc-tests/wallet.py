...
#   c) node1 mines 32 blocks, so now node 0 has 60001nwo, node 1 has 4250nwo, node2 has none.
#   d) node0 sends 601 nwo to node2, in two transactions (301 nwo, then 300 nwo).

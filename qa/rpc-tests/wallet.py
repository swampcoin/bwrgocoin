...
#   c) node1 mines 32 blocks, so now node 0 has 60001ucc, node 1 has 4250ucc, node2 has none.
#   d) node0 sends 601 ucc to node2, in two transactions (301 ucc, then 300 ucc).

...
#   c) node1 mines 32 blocks, so now node 0 has 60001bwrgocoin, node 1 has 4250bwrgocoin, node2 has none.
#   d) node0 sends 601 bwrgocoin to node2, in two transactions (301 bwrgocoin, then 300 bwrgocoin).

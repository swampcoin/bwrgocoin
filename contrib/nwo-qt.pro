...
RESOURCES += src/qt/nwo.qrc src/qt/nwo_locale.qrc

TRANSLATIONS += src/qt/locale/nwo_bg.ts \
                src/qt/locale/nwo_de.ts \
                src/qt/locale/nwo_en.ts \
                src/qt/locale/nwo_es.ts \
                src/qt/locale/nwo_fi.ts \
                src/qt/locale/nwo_fr.ts \
                src/qt/locale/nwo_it.ts \
                src/qt/locale/nwo_ja.ts \
                src/qt/locale/nwo_pl.ts \
                src/qt/locale/nwo_pt.ts \
                src/qt/locale/nwo_ru.ts \
                src/qt/locale/nwo_sk.ts \
                src/qt/locale/nwo_sv.ts \
                src/qt/locale/nwo_vi.ts \
                src/qt/locale/nwo_zh_CN.ts \
                src/qt/locale/nwo_zh_TW.ts

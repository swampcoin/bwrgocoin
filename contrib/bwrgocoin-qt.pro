...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bwrgocoin-cli.cpp \
           src/bwrgocoin-tx.cpp \
           src/bwrgocoin.cpp \
           src/db.cpp \
           ...
           src/qt/bwrgocoin.cpp \
           src/qt/bwrgocoinstrings.cpp \
...
RESOURCES += src/qt/bwrgocoin.qrc src/qt/bwrgocoin_locale.qrc

TRANSLATIONS += src/qt/locale/bwrgocoin_bg.ts \
                src/qt/locale/bwrgocoin_de.ts \
                src/qt/locale/bwrgocoin_en.ts \
                src/qt/locale/bwrgocoin_es.ts \
                src/qt/locale/bwrgocoin_fi.ts \
                src/qt/locale/bwrgocoin_fr.ts \
                src/qt/locale/bwrgocoin_it.ts \
                src/qt/locale/bwrgocoin_ja.ts \
                src/qt/locale/bwrgocoin_pl.ts \
                src/qt/locale/bwrgocoin_pt.ts \
                src/qt/locale/bwrgocoin_ru.ts \
                src/qt/locale/bwrgocoin_sk.ts \
                src/qt/locale/bwrgocoin_sv.ts \
                src/qt/locale/bwrgocoin_vi.ts \
                src/qt/locale/bwrgocoin_zh_CN.ts \
                src/qt/locale/bwrgocoin_zh_TW.ts

...
RESOURCES += src/qt/ucc.qrc src/qt/ucc_locale.qrc

TRANSLATIONS += src/qt/locale/ucc_bg.ts \
                src/qt/locale/ucc_de.ts \
                src/qt/locale/ucc_en.ts \
                src/qt/locale/ucc_es.ts \
                src/qt/locale/ucc_fi.ts \
                src/qt/locale/ucc_fr.ts \
                src/qt/locale/ucc_it.ts \
                src/qt/locale/ucc_ja.ts \
                src/qt/locale/ucc_pl.ts \
                src/qt/locale/ucc_pt.ts \
                src/qt/locale/ucc_ru.ts \
                src/qt/locale/ucc_sk.ts \
                src/qt/locale/ucc_sv.ts \
                src/qt/locale/ucc_vi.ts \
                src/qt/locale/ucc_zh_CN.ts \
                src/qt/locale/ucc_zh_TW.ts
